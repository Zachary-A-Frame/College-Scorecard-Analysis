      ...
      <div>
        <div className="container" style={{ margin: "0 auto" }}>
          <div className="option">
            ...
            <p>
              The second and third models, Lasso and Elastic Net Regression
              ...
              the predicted variable. In other words, random forest models do
              not allow you to know if a feature has a positive or negative
              effect on the outcome.
            </p>
            <p>
              The linear regression models do provide that capability via the
              sign of the feature coefficient in addition to the importance via
              the absolute value of the coefficient. Two regression models were
              used to ensure that the model results were of sufficient accuracy.
              After scaling the X features and fitting the model, the top
              features of the dataset were determined using a Recursive Feature
              Elimination model. This model allows a specific number of features
              to be chosen and then ranked by importance.
            </p>
            <p>
