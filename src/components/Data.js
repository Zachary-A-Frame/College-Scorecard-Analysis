        ...
        {loading === false ? (
          <div>
            <div className="container">
              ...
              <p>
                This file provides data descriptions for each data element
                provided in College Scorecard. Please note that datafiles
                available in the “Download All Data” provide more data elements
                and represent a larger universe of institutions than what is
                presented in the Scorecard consumer page{" "}
                <a
            ...
            <p className="container">
              The college scorecard contains nearly 2000 columns of data, to aid
              in finding particular pieces of data we have added an alphabetical
